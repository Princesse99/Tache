...
//                 className="flex items-center py-4 px-4 mt-36 mb-2 rounded hover:bg-green-700 w-full text-left"
//               >
...
//                 className="flex items-center py-4 px-4 mb-2 mt-36 rounded hover:bg-green-700 w-full text-left"
//               >
...
//       {/* Main content */}
//       <main
//         className={`flex-1 ml-64 p-6 transition-all duration-300 ${
